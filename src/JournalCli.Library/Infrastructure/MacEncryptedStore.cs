...
namespace JournalCli.Library.Infrastructure
{
        ...
        where T : class, new()
    {
        ...
        public override void Save(T target)
        {
            ...
            var cipherText = AuthenticatedEncryption.AuthenticatedEncryption.Encrypt(yaml, cryptKey, authKey);
        ...
        public override T Load()
        {
            try
            {
                ...
                var plainText = AuthenticatedEncryption.AuthenticatedEncryption.Decrypt(cipherText, cryptKey, authKey);
